...
// 	mHappiness:
// 		"x{eff} Happiness | Happiness | Multiplies EXP gain from all sources",
// 	mSkillExp:
// 		"x{eff} Skill XP | Skill XP | Multiplies EXP gain for all skills",
...
// export const rawMultipliers: MultiplierData[] = Object.entries(
// 	rawMultipliersMap
// ).map(([id, text]) => {
// 	const [effectTextTemplate, name, description] = text
// 		.split("|")
// 		.map((e) => e.trim());
// 	return {
...
// const testSkill = {
// 	id: "sTestSkill" as const,
// 	name: "testSkill" as const,
// 	description: "Improve your testing results" as const,
// 	category: "scTest" as const,
// 	// effectTextTemplate: "x{eff} Skill XP",
// 	levelExp: xpPow(50, 1.01),
// 	expMultipliers: ["mSkillExp" as const],
// 	multiplierEffects: (level: level) => ({
...
// 		id: 'sTestHappy',
// 		multiplierEffects: (level) => ({
// 			mHappiness: 1 + 0.01 * level,
// 		}),
// 	},
// ];

// const rawShopItemsMap: Record<
// 	shopItemId,
// 	`${number}|${number}|${multiplierId | ""}|${string}`
// > = {
// 	sTent: "3e0  |1.5|mHappiness|A tent",
// 	sBook: "5e0  |1.5|mSkillExp| A book to read",
// };

// export const rawShopItems: ShopItemData[] = Object.values(rawShopItemsMap).map(
// 	([id, v]): ShopItemData => {
// 		const name = id
// 			.slice(1)
// 			.replaceAll(/(.)(?=[A-Z])/g, `$1 `)
// 			.trim();
// 		const [cost, eff, mul, desc] = v.split("|").map((e) => e.trim()) as [
// 			string,
// 			string,
// 			multiplierId,
// 			displayedDesc
